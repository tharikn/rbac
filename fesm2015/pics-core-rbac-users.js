...
class UsersComponent {
    constructor(userService, fb, alertService, httpService) {
...
UsersComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0, type: UsersComponent, deps: [{ token: UserOrgService }, { token: i2.FormBuilder }, { token: AlertService }, { token: HttpService }], target: i0.ɵɵFactoryTarget.Component });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0, type: UsersComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: UserOrgService }, { type: i2.FormBuilder }, { type: AlertService }, { type: HttpService }]; }, propDecorators: { RBACORG: [{
                type: Input
            }], PERMISSION: [{
                type: Input
            }] } });
