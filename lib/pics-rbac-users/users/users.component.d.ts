...
export declare class UsersComponent implements OnInit {
    ...
    roleId: string;
    forced_clicked: boolean;
    forced_closed_by: string;
    prevent_closure: boolean;
    closure_prevention_reason: string;
    isClosureDisabled: boolean;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<UsersComponent, "users", never, { "RBACORG": { "alias": "RBACORG"; "required": false; }; "PERMISSION": { "alias": "PERMISSION"; "required": false; }; }, {}, never, never, false, never>;
}
