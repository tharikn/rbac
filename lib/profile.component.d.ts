...
export declare class ProfileComponent implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ProfileComponent, "profile", never, { "RBACORG": "RBACORG"; "PERMISSION": "PERMISSION"; "profileEvent": "profileEvent"; }, { "libOnPasswordSuccess": "libOnPasswordSuccess"; }, never, never>;
}
