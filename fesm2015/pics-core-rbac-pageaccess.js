...
class PageaccessComponent {
    ...
    getAccessByAsset(accessArray) {
        var _a;
        const pageAccessFormControl = this.rbacForm.getRawValue();
        const isPageReadAccess = (_a = pageAccessFormControl === null || pageAccessFormControl === void 0 ? void 0 : pageAccessFormControl.pageLevelData) === null || _a === void 0 ? void 0 : _a.filter(x => x.pageid == this.pId && x.pageAccess == '3')[0];
