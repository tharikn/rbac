...
class ManagementGroupsService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.2.12", ngImport: i0, type: ManagementGroupsService, deps: [{ token: HttpService }], target: i0.ɵɵFactoryTarget.Injectable });
