(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var MasterdataComponent$1 = /** @class */ (function () {
        ...
        MasterdataComponent.prototype.initializeLookupForm = function () {
            ...
            this.lookupForm = this.formBuilder.group({
                ...
                readonly: [false],
                isenabled: [true],
                lookup: this.initializeLookupDataForm()
            });
        };
        ...
        // }
        // get lookupdata() {
        //   const lookupFormGroup = this.lookupForm.get('lookup') as FormGroup;
        //   if (lookupFormGroup && lookupFormGroup.get('lookupdata') instanceof FormArray) {
        //     return lookupFormGroup.get('lookupdata') as FormArray;
        //   } 
        // }
        ...
        MasterdataComponent.prototype.nodeSelect = function (event) {
            ...
            this.mastersService.getLookupBycategoryID(event.node.data).subscribe(function (nodes) {
                ...
                lookup.lookupdata.forEach(function (data) {
                    lookupDataFormArray.push(_this.formBuilder.group({
                        id: data.id,
                        key: data.key,
                        value: data.value
                    }));
    ...
    PicsMasterdataModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: PicsMasterdataModule, declarations: [MasterdataComponent$1], imports: [i15.CommonModule,
            i2.FormsModule,
