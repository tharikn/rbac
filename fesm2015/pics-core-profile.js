...
import { Injectable, Component, Directive, Input, HostListener, EventEmitter, Output, NgModule, NO_ERRORS_SCHEMA, CUSTOM_ELEMENTS_SCHEMA } from '@angular/core';
...
class ProfileComponent$1 {
    ...
    getUserInfo() {
        this.profileService.getAllUserList(this.userid).subscribe((res) => {
            ...
            const providerData = (_b = (_a = patchValuedata.userroles[0]) === null || _a === void 0 ? void 0 : _a.defaultpage) === null || _b === void 0 ? void 0 : _b.provider[0];
            this.thumbnail = ((_d = (_c = patchValuedata.additionalinfo) === null || _c === void 0 ? void 0 : _c.thumbnail) === null || _d === void 0 ? void 0 : _d.url) || '';
            ...
            control.controls = [];
            (_e = providerData === null || providerData === void 0 ? void 0 : providerData.phone_numbers) === null || _e === void 0 ? void 0 : _e.forEach(x => {
...
DirectivesModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0, type: DirectivesModule, declarations: [PermissionDirective, ShowFieldDirective, PasswordToggleDirective], imports: [CommonModule], exports: [PermissionDirective, ShowFieldDirective, PasswordToggleDirective] });
