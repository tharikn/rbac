...
export declare class RbacUsersComponent implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<RbacUsersComponent, "rbac-users", never, { "RBACORG": { "alias": "RBACORG"; "required": false; }; "PERMISSION": { "alias": "PERMISSION"; "required": false; }; "COMMONSERVICE": { "alias": "COMMONSERVICE"; "required": false; }; "INPUTVALIDATIONMETHOD": { "alias": "INPUTVALIDATIONMETHOD"; "required": false; }; }, {}, never, never, false, never>;
}
