...
export declare class LoginComponent implements OnInit {
    ...
    constructor(injector: Injector, store$: Store<AppState>, _router: Router, fb: FormBuilder, modalService: NgbModal, alertService: AlertService, authService: AuthService, route: ActivatedRoute);
    ngOnInit(): void;
    ngOnDestroy(): void;
    initializeForm(): void;
    ...
    gotoRegistrationPage(userType: any): void;
    getSessionDetails(): void;
    generateLoginUrl(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<LoginComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<LoginComponent, "lib-login", never, { "LOGININFO": "LOGININFO"; "RBACORG": "RBACORG"; }, { "passwordExpired": "passwordExpired"; "loginSuccessful": "loginSuccessful"; }, never, never>;
}
export {};
