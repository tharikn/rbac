...
class PageaccessComponent {
    ...
    getAccessByAsset(accessArray) {
        ...
        const isPageReadAccess = (_a = pageAccessFormControl === null || pageAccessFormControl === void 0 ? void 0 : pageAccessFormControl.value) === null || _a === void 0 ? void 0 : _a.filter(x => x.pageid == this.pId && x.pageAccess == '3')[0];
