(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('@angular/forms'), require('primeng/api'), require('rxjs/operators'), require('@angular/router'), require('rxjs/add/operator/map'), require('@angular/common'), require('primeng/tree'), require('primeng/contextmenu'), require('primeng/confirmpopup'), require('primeng/card'), require('primeng/checkbox'), require('primeng/table'), require('primeng/multiselect'), require('primeng/treeselect'), require('primeng/dropdown'), require('primeng/inputtext'), require('@angular/common/http'), require('@ng-bootstrap/ng-bootstrap'), require('primeng/accordion'), require('primeng/avatar'), require('primeng/badge'), require('primeng/button'), require('primeng/calendar'), require('primeng/confirmdialog'), require('primeng/dialog'), require('primeng/editor'), require('primeng/fieldset'), require('primeng/fileupload'), require('primeng/inputmask'), require('primeng/inputswitch'), require('primeng/inputtextarea'), require('primeng/knob'), require('primeng/message'), require('primeng/orderlist'), require('primeng/password'), require('primeng/progressspinner'), require('primeng/radiobutton'), require('primeng/ripple'), require('primeng/sidebar'), require('primeng/speeddial'), require('primeng/steps'), require('primeng/tabmenu'), require('primeng/tabview'), require('primeng/toast')) :
    typeof define === 'function' && define.amd ? define('@pics-core/masterdata', ['exports', '@angular/core', 'rxjs', '@angular/forms', 'primeng/api', 'rxjs/operators', '@angular/router', 'rxjs/add/operator/map', '@angular/common', 'primeng/tree', 'primeng/contextmenu', 'primeng/confirmpopup', 'primeng/card', 'primeng/checkbox', 'primeng/table', 'primeng/multiselect', 'primeng/treeselect', 'primeng/dropdown', 'primeng/inputtext', '@angular/common/http', '@ng-bootstrap/ng-bootstrap', 'primeng/accordion', 'primeng/avatar', 'primeng/badge', 'primeng/button', 'primeng/calendar', 'primeng/confirmdialog', 'primeng/dialog', 'primeng/editor', 'primeng/fieldset', 'primeng/fileupload', 'primeng/inputmask', 'primeng/inputswitch', 'primeng/inputtextarea', 'primeng/knob', 'primeng/message', 'primeng/orderlist', 'primeng/password', 'primeng/progressspinner', 'primeng/radiobutton', 'primeng/ripple', 'primeng/sidebar', 'primeng/speeddial', 'primeng/steps', 'primeng/tabmenu', 'primeng/tabview', 'primeng/toast'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["pics-core"] = global["pics-core"] || {}, global["pics-core"].masterdata = {}), global.ng.core, global.rxjs, global.ng.forms, global.i4, global.rxjs.operators, global.ng.router, global.rxjs["add/operator/map"], global.ng.common, global.i8, global.i9, global.i10, global.i11, global.i12, global.i13, global.i14, global.i15, global.i16, global.i18, global.ng.common.http, global.ngBootstrap, global.accordion, global.avatar, global.badge, global.button, global.calendar, global.confirmdialog, global.dialog, global.editor, global.fieldset, global.fileupload, global.inputmask, global.inputswitch, global.inputtextarea, global.knob, global.message, global.orderlist, global.password, global.progressspinner, global.radiobutton, global.ripple, global.sidebar, global.speeddial, global.steps, global.tabmenu, global.tabview, global.toast));
})(this, (function (exports, i0, rxjs, i2$1, i4, operators, i1, map, i2, i8, i9, i10, i11, i12, i13, i14, i15, i16, i18, http, ngBootstrap, accordion, avatar, badge, button, calendar, confirmdialog, dialog, editor, fieldset, fileupload, inputmask, inputswitch, inputtextarea, knob, message, orderlist, password, progressspinner, radiobutton, ripple, sidebar, speeddial, steps, tabmenu, tabview, toast) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var MasterdataComponent$1 = /** @class */ (function () {
        ...
        MasterdataComponent.prototype.initializeLookupForm = function () {
            ...
            this.lookupForm = this.formBuilder.group({
                ...
                access: this.formBuilder.group({
                    assign: ['', [this.requiredIfValidator(function () { return !_this.isGlobalLookup; })]],
                    view: ['', [this.requiredIfValidator(function () { return !_this.isGlobalLookup; })]]
                }),
                order: [0],
                readonly: [false],
                global: [true],
        ...
        Object.defineProperty(MasterdataComponent.prototype, "datarules", {
            get: function () {
        ...
        MasterdataComponent.prototype.onAddRule = function () {
            this.datarules.push(this.addRule());
        };
        MasterdataComponent.prototype.onDeleteRule = function (rowIndex) {
        ...
        MasterdataComponent.prototype.nodeSelect = function (event) {
            ...
            if (event.node.type === 'lookup') {
                this.mastersService.getLookup(event.node.id).subscribe(function (item) {
                    var e_1, _b;
                    var lookup = item['data'];
                    _this.lookupForm.reset();
                    _this.setGlobal(lookup.global);
                    _this.clearRules();
                    _this.lookupForm.patchValue(lookup);
                    if (lookup.optionaldata && lookup.optionaldata.rules) {
                        try {
                            for (var _c = __values(lookup.optionaldata.rules), _d = _c.next(); !_d.done; _d = _c.next()) {
                                var rule = _d.value;
                                var ruleControl = _this.addRule();
                                ruleControl.patchValue(rule);
                                _this.datarules.push(ruleControl);
                            }
                        }
        ...
        MasterdataComponent.prototype.clearRules = function () {
            for (var index = 0; index < this.datarules.length; index++) {
        ...
        MasterdataComponent.prototype.saveCategory = function () {
            ...
            if (this.categoryForm.valid) {
                if (this.saveMode === 'INSERT') {
                    this.mastersService.createCategory(category).subscribe(function () {
        ...
        MasterdataComponent.prototype.saveLookup = function () {
            var _this = this;
            var lookup = this.lookupForm.value;
            console.log(lookup);
            if (this.lookupForm.valid) {
                delete lookup.readonly;
                lookup.order = lookup.order ? Number(lookup.order) : 1;
                if (lookup.optionaldata && lookup.optionaldata.rules) {
                    lookup.optionaldata.rules = lookup.optionaldata.rules.map(function (rule) {
                        rule.permission.parent = null;
                        return rule;
                    });
                }
                if (this.saveMode === 'INSERT') {
                    this.mastersService.createLookup(lookup).subscribe(function () {
                        _this.alertService.success('Lookup created successfully.');
                        _this.loadTree();
                    });
                }
                else {
                    this.mastersService.updateLookup(lookup).subscribe(function () {
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: MasterdataComponent$1, decorators: [{
            ...
            }], ctorParameters: function () { return [{ type: RbacService }, { type: i2__namespace$1.FormBuilder }, { type: AlertService }, { type: i4__namespace.ConfirmationService }, { type: PermissionStore }, { type: DataStoreService }]; } });
    ...
    PicsMasterdataModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: PicsMasterdataModule, declarations: [MasterdataComponent$1], imports: [i2.CommonModule,
            i2$1.FormsModule,
            i2$1.ReactiveFormsModule,
            ngBootstrap.NgbModule,
            tabmenu.TabMenuModule,
            tabview.TabViewModule,
            i15.TreeSelectModule,
